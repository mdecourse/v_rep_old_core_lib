                    ...
                    if (tt::extractSpaceSeparatedWord(value,aword))
                    {
                        ...
                        else
                        {
                            ...
                            if (index>=0)
                                ...
                                theInd=int(vertices.size()/3)+index;
                            ...
                            if (mode&1)
                            {
                                if (tindex>=0)
                                    ...
                                    theInd=int(textureCoords.size()/2)+tindex;
                            ...
                            if (mode&2)
                            {
                                if (nindex>=0)
                                    ...
                                    theInd=int(normals.size()/3)+nindex;
...
//                              }
    ...
    for (int i=0;i<int(_importedIndices.size());i++)
    {
        ...
        for (int j=0;j<int(_importedIndices[i]->size());j++)
        {
            ...
            {
                vertIndex[_importedIndices[i]->at(j)]=(int)theV->size()/3;
...
{   
    ...
    for (int i=0;i<int(vertices.size());i++)
    {
        ...
        initSize=initSize+(int)vertices[i]->size()/3;
    }
    archive.close();
    myFile.close();
    return(true);
...
{   
    ...
    for (size_t i=0;i<objects.size();i++)
    {
        ...
        if (it!=NULL)
        {
            ...
            totalVertices=totalVertices+(int)wvert.size()/3;
        }
    }
    int initSize=0;
    for (size_t i=0;i<objects.size();i++)
