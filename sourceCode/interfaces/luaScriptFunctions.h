...
extern int _simDisplayDialog(luaWrap_lua_State* L);
extern int _simGetDialogResult(luaWrap_lua_State* L);
extern int _simGetDialogInput(luaWrap_lua_State* L);
extern int _simEndDialog(luaWrap_lua_State* L);
