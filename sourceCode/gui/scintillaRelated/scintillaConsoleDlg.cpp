...
void CScintillaConsoleDlg::qtInitialize()
{
    ...
    const unsigned int blueGrey=VRGB(128,128,255);
    ...
    _setAStyle(QsciScintillaBase::STYLE_DEFAULT,VRGB(int(info->_textColor[0]*255.0f),int(info->_textColor[1]*255.0f),int(info->_textColor[2]*255.0f)),VRGB(int(info->_backgroundColor[0]*255.0f),int(info->_backgroundColor[1]*255.0f),int(info->_backgroundColor[2]*255.0f)),fontSize,theFont.c_str()); // set global default style
